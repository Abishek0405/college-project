                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto my-2 my-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link" style=" color:  #f4623a;"  href="manage.jsp">Manage Products</a></li>
                         ...
                         <li class="nav-item"><a class="nav-link" style=" color:  #f4623a;"  href="vfeed.jsp">View Feedback</a></li>
                   ...
                   %> 
                    <table align="center">
                        <tr align="center"><td><strong>User Id</strong> </td><td style="color:black"><input type="text" name="id" value="<%=id%>" readonly=""></td></tr>
                            ...
                            <tr align="center"><td><strong>User Feedback</strong> </td><td style="color:lightseagreen"><input type="text" name="feed" value="<%=rs.getString("feed")%>" readonly=""></td></tr>
                             <tr align="center"><td><strong>Give Response</strong> </td><td style="color:lightseagreen"><input type="text" name="respons" value=""></td></tr>
                             <tr><td align="center" colspan="2">
                                     <button type="submit?respons=<%=rs.getString("respons")%>" style="border-radius: 20px; height: 40px; width:200px; background-color:#f4623a ">
